...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip Hover */}
      <span className="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-surface text-primary text-sm px-4 py-2 rounded-xl shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap font-medium border border-secondary/30">
        Tanya Ketersediaan
      </span>
